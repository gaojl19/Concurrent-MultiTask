...
from agents.bc_agent import MultiNetAgent
...
class BC_Trainer(object):
    def __init__(self, args, params):
        ...
        cls_args = {"push": dict(args=[], kwargs={'obs_type': params['meta_env']['obs_type'], 'task_types': ["push-1", "push-2"]})}
        ...
        self.args['agent_class'] = MultiNetAgent
        ...
        agent = MultiNetAgent(self.env, self.args['agent_params'])
        ...
        # LOG PREFIX
        log_prefix = "./fig/MultiNet_baseline/" 
